...
function pineault_setup() {
  ...
  wp_enqueue_style('aos.css', get_theme_file_uri() . '/aos/dist/aos.css', NULL, microtime());
  ...
  wp_enqueue_script('aos.js', get_theme_file_uri () . '/aos/dist/aos.js', NULL, microtime(), true);
